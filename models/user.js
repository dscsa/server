...
function saveLogin(doc, opts) {
  ...
  if (doc.password) {
    ...
    console.log('saveLogin', '_user', _user, 'doc', doc, 'admin', admin, 'account', opts.ctx && opts.ctx.account, 'headers', opts.ctx && opts.ctx.headers, 'cookies', opts.ctx && opts.ctx.cookies.get())
